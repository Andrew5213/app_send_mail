...
$lista_coisas[] = [1 => 'banana', 2 => 'maca', 3 => 'morango', 4 => 'uva']; // este => e a associação da chave ou seja o indice do vetor
$lista_pessoas[] = [1 => 'joao', 2 => 'jose', 3 => 'maria'];
//echo '<pre>';
...
$lista_coisas = array_push($lista_pessoas);
echo '<pre>';
print_r($lista_coisas);
echo '</pre>';
